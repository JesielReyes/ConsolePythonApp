...
type Props = { account: Account; admin?: boolean; onSelect: (account: Account) => void; onToggleStatus?: (accountNumber: string) => void }

export function AccountCard({ account, admin = false, onSelect, onToggleStatus }: Props) {
