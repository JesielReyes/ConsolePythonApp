...
type Props = { account: Account; transactions: Transaction[]; onClose: () => void; onWithdraw?: (account: Account) => void; admin?: boolean; ownerName?: string }

export function AccountDetailsModal({ account, transactions, onClose, onWithdraw, admin = false, ownerName }: Props) {
